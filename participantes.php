...
?>
    ...
    <section class="seccion-morada inicial pb-5">
        <div class="container">
            <h1 class="mb-3 titulo-1">Cortos a concurso</h1>
            <p class="parrafo-1">¡No te olvides que en este festival tienes el poder! Los ganadores se elegirán gracias a <a href="participantes.php" class="link-interno verde"> tu participación.</a></p>
        </div>
    </section>
    ...
    <section class="container-fluid mt-4">
            <div class="container">
                <div class="menu-filtro pb-3 px-4">
                    ...
                    <button id="toggleCategoria" class="boton-mas">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                            <rect x="2.5" y="21.25" width="45" height="7.5" rx="3.75" ry="3.75" transform="translate(25 -10.355) rotate(45)" fill="inherit" stroke-width="0"/>
                            <rect x="21.705" y="13.295" width="22.5" height="7.5" rx="3.75" ry="3.75" transform="translate(68.31 5.795) rotate(135)" fill="inherit" stroke-width="0"/>
                            <rect x="5.795" y="29.205" width="22.5" height="7.5" rx="3.75" ry="3.75" transform="translate(52.4 44.205) rotate(135)" fill="inherit" stroke-width="0"/>
                        </svg>
                    </button>
                </div>
                ...
                <section id="contenedorTarjetasCortos" class="cortos mt-md-5 d-flex align-items-center justify-content-start flex-wrap">
                    ...
                    <article class="tarjeta-corto container mb-1 col-12 col-md-8 col-xl-4 " data-category="Video">
                        ...
                        <div class="row g-0 flex-column align-items-center ">
                            ...
                            <div
                                ...
                                <img src="img/foto-tarjeta-crescendo.jpeg" alt="">
                            </div>
                    ...
                    <article class="tarjeta-corto container mb-1 col-12 col-md-8 col-xl-4" data-category="StopMotion">
                        ...
                        <div class="row g-0 flex-column align-items-center">
                            ...
                            <div
                                class="tarjeta-superior d-flex flex-column align-items-center justify-content-center p-3 col-12">
                                <img src="img/foto-tarjeta-corto-6.jpeg" alt="">
                            </div>
                            ...
                            <div class="tarjeta-inferior col-12">
                                <div class="d-flex">
                                    <div class="info-inferior p-3 pt-0 col-8">
                                        ...
                                        <h3 class="tarjeta-titulo">A la selva</h3>
                                        <ul class="tarjeta-list pt-2 mt-2">
                                            <li class="d-flex tarjeta-info ">Equipo:<p class="ps-2"> Maria's five
                                                </p>
                                            </li>
                            ...
                            <div class="tarjeta-inferior col-12">
                                <div class="d-flex">
                                    <div class="info-inferior p-3 pt-0 col-8">
                                        ...
                                        <h3 class="tarjeta-titulo">El cuento</h3>
                                        <ul class="tarjeta-list pt-2 mt-2">
                            ...
                            <div class="tarjeta-inferior col-12">
                                <div class="d-flex">
                                    <div class="info-inferior p-3 pt-0 col-8">
                                        ...
                                        <h3 class="tarjeta-titulo">El inicio</h3>
                                        <ul class="tarjeta-list pt-2 mt-2">
                                            <li class="d-flex tarjeta-info ">Equipo:<p class="ps-2"> Cr3W
                                                </p>
                                            </li>
                                            <li class="d-flex tarjeta-info ">Género:<p class="ps-2"> Acción</p>
                                            </li>
                                            <li class="d-flex tarjeta-info ">Duración:<p class="ps-2"> 15 min.</p>
                                            </li>
                                        </ul>
                    ...
                    <article class="tarjeta-corto container mb-1 col-12 col-md-8 col-xl-4" data-category="Animacion">
                        ...
                        <div class="row g-0 flex-column align-items-center">
                            ...
                            <div
                                class="tarjeta-superior d-flex flex-column align-items-center justify-content-center p-3 col-12">
                                <img src="img/foto-tarjeta-corto-7.jpeg" alt="">
                            </div>
                            ...
                            <div class="tarjeta-inferior col-12">
                                <div class="d-flex">
                                    <div class="info-inferior p-3 pt-0 col-8">
                                        ...
                                        <h3 class="tarjeta-titulo">3, 2, 1 ¡Brava!</h3>
                                        <ul class="tarjeta-list pt-2 mt-2">
                                            <li class="d-flex tarjeta-info ">Equipo:<p class="ps-2"> Musas
                                                </p>
                                            </li>
                                            <li class="d-flex tarjeta-info ">Género:<p class="ps-2"> Comedia</p>
                                            </li>
                                            <li class="d-flex tarjeta-info ">Duración:<p class="ps-2"> 13 min.</p>
                                            </li>
                                        </ul>
                    ...
                    <article class="tarjeta-corto container mb-1 col-12 col-md-8 col-xl-4 " data-category="Video">
                        ...
                        <div class="row g-0 flex-column align-items-center ">
                            ...
                            <div
                                class="tarjeta-superior d-flex flex-column align-items-center justify-content-center p-3 col-12">
                                <img src="img/foto-tarjeta-corto-8.jpeg" alt="">
                            </div>
                            ...
                            <div class="tarjeta-inferior col-12">
                                <div class="d-flex">
                                    <div class="info-inferior p-3 pt-0 col-8">
                                        ...
                                        <h3 class="tarjeta-titulo">Meteoro</h3>
                                        <ul class="tarjeta-list pt-2 mt-2">
                                            <li class="d-flex tarjeta-info ">Equipo:<p class="ps-2"> LGG
                                                </p>
                                            </li>
                                            <li class="d-flex tarjeta-info ">Género:<p class="ps-2"> Romance</p>
                                            </li>
                                            <li class="d-flex tarjeta-info ">Duración:<p class="ps-2"> 15 min.</p>
                                            </li>
                                        </ul>
